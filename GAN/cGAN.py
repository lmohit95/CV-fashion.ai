...
def create_discriminator(image_shape):
	...
	discriminator_model.compile(loss='binary_crossentropy', optimizer=optimizer, loss_weights=[0.5])    
...
def train(discriminator_model, generator_model, gan_model, dataset, num_epochs=100, batch_size=1):
	...
	for i in range(total_steps):
		...
		g_loss, _, _ = gan_model.train_on_batch(real_samples, [y_real, real_labels])
